...
--
-- Host: localhost
-- Generation Time: Apr 03, 2023 at 03:16 PM
...
--
ALTER TABLE `employee_leave`
  MODIFY `token` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=311;

--
-- AUTO_INCREMENT for table `project`
--
ALTER TABLE `project`
  MODIFY `pid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
